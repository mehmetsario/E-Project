            ...
            <div class="footer-shipping pt-60 pb-55 pb-xs-25">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                        <div class="li-shipping-inner-box">
                            <div class="shipping-icon">
                                <img src="{{asset('assets/site/images/shipping-icon/1.png')}}" alt="Shipping Icon">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                        <div class="li-shipping-inner-box">
                            <div class="shipping-icon">
                                <img src="{{asset('assets/site/images/shipping-icon/2.png')}}" alt="Shipping Icon">
                            </div>
                            <div class="shipping-text">
                                <h2>Safe Payment</h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                        <div class="li-shipping-inner-box">
                            <div class="shipping-icon">
                                <img src="{{asset('assets/site/images/shipping-icon/3.png')}}" alt="Shipping Icon">
                            </div>
                            <div class="shipping-text">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                        <div class="li-shipping-inner-box">
                            <div class="shipping-icon">
                                <img src="{{asset('assets/site/images/shipping-icon/4.png')}}" alt="Shipping Icon">
                            </div>
                            <div class="shipping-text">
...
<!-- Ajax Mail js -->
<script src="{{asset('assets/site/js/ajax-mail.js')}}"></script>
<!-- Meanmenu js -->
...
<!-- Mixitup js -->
<script src="{{asset('assets/site/js/jquery.mixitup.min.js')}}"></script>
<!-- Countdown -->
...
<!-- Barrating -->
<script src="{{asset('assets/site/js/jquery.barrating.min.js')}}"></script>
<!-- Jquery-ui -->
<script src="{{asset('assets/site/js/jquery-ui.min.js')}}"></script>
<!-- Venobox -->
<script src="{{asset('assets/site/js/venobox.min.js')}}"></script>
<!-- Nice Select js -->
<script src="{{asset('assets/site/js/jquery.nice-select.min.js')}}"></script>
<!-- ScrollUp js -->
<script src="{{asset('assets/site/js/scrollUp.min.js')}}"></script>
<!-- Main/Activator js -->
