        ...
        @foreach ($item as $product)
            <tr>
                ...
                @if($categories->count() > 0)
                    ...
                    @endforeach
                @else
                    <td style="color: red">You have to edit this Item and choose category for it</td>
                @endif
                @if($var==0)
                    <td style="color: red">You have to edit this Item and choose category for it</td> @endif
                                                                ...
                                                                <form class="form-horizontal" method="POST"
                                                                    ...
                                                                    <div class="form-group mb-4">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <select
                                                                                    class="form-control form-custom mb-4"
                                                                                    name="category_id">
                                                                            ...
                                                                            <div class="mb-3">
                                                                                <div class="custom-file">
                                                                                    <input type="file"
                                                                                           ...
                                                                                           id="file-input" name="image"
                                                                                           value="{{'assets/site/images/product/'.$product->image}}">
                                                                                </div>
                                                                            </div>
